...
public class CatalogDataProductAttributeInterface {
  ...
  public boolean equals(Object o) {
    ...
    return (this.isWysiwygEnabled == null ? catalogDataProductAttributeInterface.isWysiwygEnabled == null : this.isWysiwygEnabled.equals(catalogDataProductAttributeInterface.isWysiwygEnabled)) &&
        (this.isHtmlAllowedOnFront == null ? catalogDataProductAttributeInterface.isHtmlAllowedOnFront == null : this.isHtmlAllowedOnFront.equals(catalogDataProductAttributeInterface.isHtmlAllowedOnFront)) &&
        (this.usedForSortBy == null ? catalogDataProductAttributeInterface.usedForSortBy == null : this.usedForSortBy.equals(catalogDataProductAttributeInterface.usedForSortBy)) &&
        (this.isFilterable == null ? catalogDataProductAttributeInterface.isFilterable == null : this.isFilterable.equals(catalogDataProductAttributeInterface.isFilterable)) &&
        (this.isFilterableInSearch == null ? catalogDataProductAttributeInterface.isFilterableInSearch == null : this.isFilterableInSearch.equals(catalogDataProductAttributeInterface.isFilterableInSearch)) &&
        (this.isUsedInGrid == null ? catalogDataProductAttributeInterface.isUsedInGrid == null : this.isUsedInGrid.equals(catalogDataProductAttributeInterface.isUsedInGrid)) &&
        (this.isVisibleInGrid == null ? catalogDataProductAttributeInterface.isVisibleInGrid == null : this.isVisibleInGrid.equals(catalogDataProductAttributeInterface.isVisibleInGrid)) &&
        (this.isFilterableInGrid == null ? catalogDataProductAttributeInterface.isFilterableInGrid == null : this.isFilterableInGrid.equals(catalogDataProductAttributeInterface.isFilterableInGrid)) &&
        (this.position == null ? catalogDataProductAttributeInterface.position == null : this.position.equals(catalogDataProductAttributeInterface.position)) &&
        (this.applyTo == null ? catalogDataProductAttributeInterface.applyTo == null : this.applyTo.equals(catalogDataProductAttributeInterface.applyTo)) &&
        (this.isSearchable == null ? catalogDataProductAttributeInterface.isSearchable == null : this.isSearchable.equals(catalogDataProductAttributeInterface.isSearchable)) &&
        (this.isVisibleInAdvancedSearch == null ? catalogDataProductAttributeInterface.isVisibleInAdvancedSearch == null : this.isVisibleInAdvancedSearch.equals(catalogDataProductAttributeInterface.isVisibleInAdvancedSearch)) &&
        (this.isComparable == null ? catalogDataProductAttributeInterface.isComparable == null : this.isComparable.equals(catalogDataProductAttributeInterface.isComparable)) &&
        (this.isUsedForPromoRules == null ? catalogDataProductAttributeInterface.isUsedForPromoRules == null : this.isUsedForPromoRules.equals(catalogDataProductAttributeInterface.isUsedForPromoRules)) &&
        (this.isVisibleOnFront == null ? catalogDataProductAttributeInterface.isVisibleOnFront == null : this.isVisibleOnFront.equals(catalogDataProductAttributeInterface.isVisibleOnFront)) &&
        (this.usedInProductListing == null ? catalogDataProductAttributeInterface.usedInProductListing == null : this.usedInProductListing.equals(catalogDataProductAttributeInterface.usedInProductListing)) &&
        (this.isVisible == null ? catalogDataProductAttributeInterface.isVisible == null : this.isVisible.equals(catalogDataProductAttributeInterface.isVisible)) &&
        (this.scope == null ? catalogDataProductAttributeInterface.scope == null : this.scope.equals(catalogDataProductAttributeInterface.scope)) &&
        (this.attributeId == null ? catalogDataProductAttributeInterface.attributeId == null : this.attributeId.equals(catalogDataProductAttributeInterface.attributeId)) &&
        (this.attributeCode == null ? catalogDataProductAttributeInterface.attributeCode == null : this.attributeCode.equals(catalogDataProductAttributeInterface.attributeCode)) &&
        (this.frontendInput == null ? catalogDataProductAttributeInterface.frontendInput == null : this.frontendInput.equals(catalogDataProductAttributeInterface.frontendInput)) &&
        (this.entityTypeId == null ? catalogDataProductAttributeInterface.entityTypeId == null : this.entityTypeId.equals(catalogDataProductAttributeInterface.entityTypeId)) &&
        (this.isRequired == null ? catalogDataProductAttributeInterface.isRequired == null : this.isRequired.equals(catalogDataProductAttributeInterface.isRequired)) &&
        (this.options == null ? catalogDataProductAttributeInterface.options == null : this.options.equals(catalogDataProductAttributeInterface.options)) &&
        (this.isUserDefined == null ? catalogDataProductAttributeInterface.isUserDefined == null : this.isUserDefined.equals(catalogDataProductAttributeInterface.isUserDefined)) &&
        (this.defaultFrontendLabel == null ? catalogDataProductAttributeInterface.defaultFrontendLabel == null : this.defaultFrontendLabel.equals(catalogDataProductAttributeInterface.defaultFrontendLabel)) &&
        (this.frontendLabels == null ? catalogDataProductAttributeInterface.frontendLabels == null : this.frontendLabels.equals(catalogDataProductAttributeInterface.frontendLabels)) &&
        (this.note == null ? catalogDataProductAttributeInterface.note == null : this.note.equals(catalogDataProductAttributeInterface.note)) &&
        (this.backendType == null ? catalogDataProductAttributeInterface.backendType == null : this.backendType.equals(catalogDataProductAttributeInterface.backendType)) &&
        (this.backendModel == null ? catalogDataProductAttributeInterface.backendModel == null : this.backendModel.equals(catalogDataProductAttributeInterface.backendModel)) &&
        (this.sourceModel == null ? catalogDataProductAttributeInterface.sourceModel == null : this.sourceModel.equals(catalogDataProductAttributeInterface.sourceModel)) &&
        (this.defaultValue == null ? catalogDataProductAttributeInterface.defaultValue == null : this.defaultValue.equals(catalogDataProductAttributeInterface.defaultValue)) &&
        (this.isUnique == null ? catalogDataProductAttributeInterface.isUnique == null : this.isUnique.equals(catalogDataProductAttributeInterface.isUnique)) &&
        (this.frontendClass == null ? catalogDataProductAttributeInterface.frontendClass == null : this.frontendClass.equals(catalogDataProductAttributeInterface.frontendClass)) &&
        (this.validationRules == null ? catalogDataProductAttributeInterface.validationRules == null : this.validationRules.equals(catalogDataProductAttributeInterface.validationRules)) &&
        (this.customAttributes == null ? catalogDataProductAttributeInterface.customAttributes == null : this.customAttributes.equals(catalogDataProductAttributeInterface.customAttributes));
  }
