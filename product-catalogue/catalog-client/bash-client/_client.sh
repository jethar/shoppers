...
case $state in
  ops)
    ...
    _values "Operations" \
            ...
            "catalogProductWebsiteLinkRepositoryV1SavePut[]"             "addProduct[Add a new product to the store]" \
            "deleteProduct[Deletes a product]" \
            "findProductsByCategories[Finds Products by category]" \
            "getProductById[Find product by ID]" \
            "updateProductWithForm[Updates a product in the store with form data]" 
...
"websiteId=:"
      ...
      getProductById)
        local -a _op_arguments
        _op_arguments=(
          "productId=:ID of product that needs to be fetched"
                    )
        _describe -t actions 'operations' _op_arguments && ret=0
        ;;
      updateProductWithForm)
        local -a _op_arguments
        _op_arguments=(
          "productId=:ID of product that needs to be updated"
                    )
        _describe -t actions 'operations' _op_arguments && ret=0
        ;;
    esac
