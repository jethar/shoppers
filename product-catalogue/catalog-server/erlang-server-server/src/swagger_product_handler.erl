%% basic handler
-module(swagger_product_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'FindProductsByCategories'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'UpdateProductWithForm'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'AddProduct' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'DeleteProduct' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'FindProductsByCategories' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'GetProductById' = OperationID,
        logic_handler = LogicHandler
    }
) ->
    From = header,
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'UpdateProductWithForm' = OperationID,
        logic_handler = LogicHandler
    }
) ->
