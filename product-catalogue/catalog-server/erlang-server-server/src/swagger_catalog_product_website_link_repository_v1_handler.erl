%% basic handler
-module(swagger_catalog_product_website_link_repository_v1_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1DeleteByIdDelete'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1SavePost'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1SavePut'
    }
) ->
    {[<<"PUT">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1DeleteByIdDelete' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1SavePost' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductWebsiteLinkRepositoryV1SavePut' = OperationID,
        logic_handler = LogicHandler
    }
) ->
