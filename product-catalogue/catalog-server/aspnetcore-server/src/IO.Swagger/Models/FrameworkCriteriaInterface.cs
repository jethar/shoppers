...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class FrameworkCriteriaInterface :  IEquatable<FrameworkCriteriaInterface>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FrameworkCriteriaInterface" /> class.
        /// </summary>
        ...
        public FrameworkCriteriaInterface(string MapperInterfaceName = null, List<FrameworkCriteriaInterface> CriteriaList = null, List<string> Filters = null, List<string> Orders = null, List<string> Limit = null)
        {
            // to ensure "MapperInterfaceName" is required (not null)
            if (MapperInterfaceName == null)
            {
                throw new InvalidDataException("MapperInterfaceName is a required property for FrameworkCriteriaInterface and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CriteriaList is a required property for FrameworkCriteriaInterface and cannot be null");
            }
            else
            {
            ...
            if (Filters == null)
            {
                throw new InvalidDataException("Filters is a required property for FrameworkCriteriaInterface and cannot be null");
            }
            else
            {
            ...
            if (Orders == null)
            {
                throw new InvalidDataException("Orders is a required property for FrameworkCriteriaInterface and cannot be null");
            }
            else
            {
                this.Orders = Orders;
            ...
            if (Limit == null)
            {
                throw new InvalidDataException("Limit is a required property for FrameworkCriteriaInterface and cannot be null");
            }
            else
            {
                this.Limit = Limit;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((FrameworkCriteriaInterface)obj);
        }

        /// <summary>
        /// Returns true if FrameworkCriteriaInterface instances are equal
        /// </summary>
        /// <param name="other">Instance of FrameworkCriteriaInterface to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FrameworkCriteriaInterface other)
        {
        ...
        public static bool operator ==(FrameworkCriteriaInterface left, FrameworkCriteriaInterface right)
        {
