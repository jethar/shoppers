...
from swagger_server.models.product_custom_option_interface import ProductCustomOptionInterface
from swagger_server.models.product_extension_interface import ProductExtensionInterface
from swagger_server.models.product_link_interface import ProductLinkInterface
...
class Product(Model):
    ...
    def __init__(self, id: int=None, sku: str=None, name: str=None, attribute_set_id: int=None, price: float=None, status: int=None, visibility: int=None, type_id: str=None, created_at: str=None, updated_at: str=None, weight: float=None, extension_attributes: ProductExtensionInterface=None, product_links: List[ProductLinkInterface]=None, options: List[ProductCustomOptionInterface]=None, tier_prices: List[ProductTierPriceInterface]=None, custom_attributes: List[FrameworkAttributeInterface]=None):
        ...
        :type product_links: List[ProductLinkInterface]
        :param options: The options of this Product.
        :type options: List[ProductCustomOptionInterface]
        :param tier_prices: The tier_prices of this Product.
        :type tier_prices: List[ProductTierPriceInterface]
    ...
    @property
    def product_links(self) -> List[ProductLinkInterface]:
        """
    ...
    def product_links(self, product_links: List[ProductLinkInterface]):
        """
    ...
    @property
    def options(self) -> List[ProductCustomOptionInterface]:
        """
    ...
    @options.setter
    def options(self, options: List[ProductCustomOptionInterface]):
        """
    ...
    @property
    def tier_prices(self) -> List[ProductTierPriceInterface]:
        """
    ...
    @tier_prices.setter
    def tier_prices(self, tier_prices: List[ProductTierPriceInterface]):
        """
