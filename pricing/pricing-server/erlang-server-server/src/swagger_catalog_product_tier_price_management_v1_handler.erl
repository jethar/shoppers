%% basic handler
-module(swagger_catalog_product_tier_price_management_v1_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1AddPost'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1GetListGet'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1RemoveDelete'
    }
) ->
    {[<<"DELETE">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1AddPost' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1GetListGet' = OperationID,
        logic_handler = LogicHandler
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CatalogProductTierPriceManagementV1RemoveDelete' = OperationID,
        logic_handler = LogicHandler
    }
) ->
