...
request_params('CatalogProductTierPriceManagementV1AddPost') ->
    [
        'sku',
        'customerGroupId',
        'price',
...
request_params('CatalogProductTierPriceManagementV1GetListGet') ->
    [
        'sku',
        'customerGroupId'
    ];

request_params('CatalogProductTierPriceManagementV1RemoveDelete') ->
    [
        'sku',
        'customerGroupId',
        'qty'
...
request_param_info('CatalogProductTierPriceManagementV1AddPost', 'sku') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1AddPost', 'customerGroupId') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1AddPost', 'price') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'float'},
...
request_param_info('CatalogProductTierPriceManagementV1AddPost', 'qty') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'float'},
...
request_param_info('CatalogProductTierPriceManagementV1GetListGet', 'sku') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1GetListGet', 'customerGroupId') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1RemoveDelete', 'sku') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1RemoveDelete', 'customerGroupId') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('CatalogProductTierPriceManagementV1RemoveDelete', 'qty') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'float'},
...
validate_response('CatalogProductTierPriceManagementV1AddPost', 200, Body, ValidatorState) ->
    validate_response_body('boolean', 'boolean', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1AddPost', 400, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1AddPost', 401, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1AddPost', 0, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);

validate_response('CatalogProductTierPriceManagementV1GetListGet', 200, Body, ValidatorState) ->
    validate_response_body('list', 'product-tier-price-interface', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1GetListGet', 400, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1GetListGet', 401, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1GetListGet', 0, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);

validate_response('CatalogProductTierPriceManagementV1RemoveDelete', 200, Body, ValidatorState) ->
    validate_response_body('boolean', 'boolean', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1RemoveDelete', 400, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1RemoveDelete', 401, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
validate_response('CatalogProductTierPriceManagementV1RemoveDelete', 0, Body, ValidatorState) ->
    validate_response_body('error-response', 'error-response', Body, ValidatorState);
